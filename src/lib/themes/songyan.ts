...
function makeSongyanConfig(p: Palette): LayoutConfig {
  ...
  return {
    ...
    components: {
      ...
      coverTitle: `margin:0 0 30px;font-size:26px;font-weight:900;color:${co.text};line-height:1.4;text-align:center;`,
      ...
      toc: `margin:0 0 30px;`,
      tocTitle: `width:100%;table-layout:fixed;border-collapse:collapse;border:0;margin:0 0 12px;background:transparent;`,
      ...
      pillItem: `display:inline-block;font-size:13px;font-weight:600;color:${co.ink};background:${co.paperDeep};padding:5px 12px;border-radius:999px;border:1px solid ${co.rule};max-width:100%;box-sizing:border-box;`,
